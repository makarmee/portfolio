...
const ProjectCard = ({ project }: { project: ProjectProps }) => (
  <div className="card bg-neutral-800 flex flex-col sm:flex-row sm:gap-10 gap-6 items-center px-6 pb-6 sm:p-10 rounded-lg sm:w-4/5 w-full max-w-[360px] sm:max-w-none justify-self-center sm:justify-self-end">
